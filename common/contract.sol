...
contract ContractManager is Ownable {
    ...
    */
        ...
        nonZeroAddress(implementation)
    {
        ...
        require(bytes(listingId).length>0, "Empty string passed as listing ID");
    ...
    */
        ...
        versionExists(contractName, versionName)
    {
        ...
        contractVsVersions[contractName][versionName].userIds = userIds;
        contractVsVersions[contractName][versionName].winningBid = winningBid;
